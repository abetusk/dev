...
It looks like the controller failed (it's not showing up as a USB controller anymore).
I replaced the controller on the cnc3018pro with the with one from the cnc1610.

Here is a snapshot of the configuration I have now:
